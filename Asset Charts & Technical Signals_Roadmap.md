...
| Phase 1 · Core MVP                      | In progress | The core workflow is usable across 33 series with line/area/candle modes, period aggregation, volume, indicators, recent views, range measurement, asset ratios, 20/60/120-day correlations, transmission carousel, export, and alerts. Full-roadmap acceptance still requires chart event/transmission markers, interactive chain validation, richer indicator/market-structure coverage, explicit adjustment choices where the source supports them, and mobile drawer/keyboard verification. |
