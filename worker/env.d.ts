/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false worker/env.d.ts` (hash: 531c1fe1700eab89fcf3cfeb551e8a07)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	GITHUB_DATA_BASE: string;
	BINANCE_FUTURES_PUBLIC_BASE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_DATA_BASE" | "BINANCE_FUTURES_PUBLIC_BASE" | "ALLOWED_ORIGINS" | "BINANCE_TESTNET_API_KEY" | "BINANCE_TESTNET_API_SECRET">> {}
}
